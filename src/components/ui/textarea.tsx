...
const Textarea = React.forwardRef<HTMLTextAreaElement, TeaxtareaProps>(
    ({ className, ...props }, ref) => {
        ...
        return (
            <motion.div
                style={{background: useMotionTemplate`radial-gradient(${visible ? radius + "px" : "0px"} circle at ${mouseX}px ${mouseY}px,var(--blue-500),transparent 80%)`,}}
